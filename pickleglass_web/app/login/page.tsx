      ...
      if (user) {
        ...
        if (isElectronMode) {
          try {
            ...
            setTimeout(() => {
              alert('Login completed. Please return to Paragon Glass app.')
            }, 1000)
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Welcome to Paragon Glass</h1>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md border border-gray-200">
          ...
          <div className="mt-4 text-center">
            <button
              onClick={() => {
                if (isElectronMode) {
                  window.location.href = 'pickleglass://auth-success?uid=default_user&email=contact@paragon.com&displayName=Default%20User'
                } else {
                  router.push('/settings')
                }
              }}
