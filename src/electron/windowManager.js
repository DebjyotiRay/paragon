...
function setupApiKeyIPC() {
    ...
    // Handler for setting AWS credentials
    ipcMain.handle('set-aws-credentials', async (event, credentials) => {
        console.log('[WindowManager] Setting AWS credentials');
        ...
        console.log('[WindowManager] AWS credentials set in environment variables');
        console.log(`[WindowManager] AWS Access Key ID: ${credentials.accessKey.substring(0, 5)}...`);
        console.log(`[WindowManager] AWS Region: ${credentials.region || 'us-east-1'}`);
